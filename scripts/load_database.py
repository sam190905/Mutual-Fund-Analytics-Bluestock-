...
from paths import DB_DIR, PROCESSED_DIR, SQL_DIR
...
print("\nGenerating dim_date...")
nav_df = pd.read_csv(PROCESSED_DIR / "clean_02_nav_history.csv")
...
print("\nLoading fact tables...")
nav = pd.read_csv(PROCESSED_DIR / "clean_02_nav_history.csv")
